...
const Example = () => {
  ...
  return (
      <MainLayout color={color} subject={subject}>
        ...
        <DeliveryguysCard name={"Paul"} city={"Les cluuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuds"} orders={2} trips={15} timetable={[{available: true},{available: false},{available: true},{available: false},{available: false},{available: true},{available: true},{available: false},{available: true},{available: false},{available: true},{available: true}]} />
